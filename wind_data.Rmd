...
model_d <- as_datetime(Sys.time(), tz="America/Los_Angeles") %>% 
  as.character()

model_dates <-  str_sub(model_d, 1, nchar(mod_time) -9)
...
string <- paste0("hours_since_ModRun(", mod_time ,"):")
