...
url_ucomp <- paste0("https://www.ncei.noaa.gov/thredds/ncss/model-nam218/",year , month, "/", year, month, day,"/nam_218_", year, month, day,"_2400_084.grb2?var=u-component_of_wind_planetary_boundary&north=34.75&west=-121.4&east=-117.07&south=32.36&disableProjSubset=on&horizStride=1")

url_ucomp <- ("http://api.planetos.com/v1/datasets/noaa_nam_awips_12/point?var=u-component_of_wind_planetary_boundary&lat=34.383252&lon=-119.005152&buffer=10&nearest=false&reftime_recent=true&max_count=true&apikey=e5102ee5d77e422eaa5dea4124ba2165")
...
wind_ras_brick <- rasterFromXYZ(clean_wind_ras)
...
re_samp_wind <- resample(wave_ras_brick, new_ras_wind, method = "bilinear")
